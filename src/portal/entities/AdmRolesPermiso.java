 ...
 */
@Entity
@Table(name="\"ADM_ROLES_PERMISOS\"", schema="sismar")
...
public class AdmRolesPermiso implements Serializable {
	...
	@Id
	@TableGenerator(name="ADM_ROLES_PERMISOS_SQ", schema="sismar", table="CONTADOR", pkColumnName="CNT_NOMBRE",valueColumnName="CNT_VALOR", allocationSize=1)
	@GeneratedValue(strategy=GenerationType.TABLE, generator="ADM_ROLES_PERMISOS_SQ")
	@Column(name="\"RLP_ID\"")
	private long rlpId;
